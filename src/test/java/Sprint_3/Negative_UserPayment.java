...
public class Negative_UserPayment  extends User_LoginPage {
...
public PropertyFileUtility pUtility = new PropertyFileUtility();
			...
			public void login() throws InterruptedException, EncryptedDocumentException, IOException {
				...
				GoldBharat_UserOrderPick OrderPicker = new GoldBharat_UserOrderPick(driver);
				Thread.sleep(2000);
				...
				Thread.sleep(5000);
				OrderPicker.getProfileIcon().click();;
				Thread.sleep(2000);
				OrderPicker.getOrders().click();
				Thread.sleep(4000);
				JavascriptExecutor js = (JavascriptExecutor) driver;
				js.executeScript("window.scrollBy(500,500)");
				OrderPicker.clickOnConformpaymentBtn();
				Thread.sleep(4000);
				OrderPicker.clickOnSubmitBtn();
				Thread.sleep(4000);
				OrderPicker.getOrderPick().click();
				Thread.sleep(1000);
				OrderPicker.getOrderPick().sendKeys(Keys.ARROW_DOWN, Keys.ENTER);	
				OrderPicker.getName().sendKeys("Pavani");
				OrderPicker.getNumber().sendKeys("6309631698");
				OrderPicker.getID().sendKeys("12345677888888");
				String projectPath= System.getProperty("user.dir");
				OrderPicker.getUploadID().sendKeys(projectPath+"\\Images\\AadhaarCard.jpg");
				System.out.println(projectPath+"\\Images\\AadhaarCard.jpg");
				Thread.sleep(3000);
				OrderPicker.getSubmit().click();
				OrderPicker.clickOnCloseBtn();
				wUtility.scrolldown(driver);
				Thread.sleep(2000);
				Thread.sleep(2000);
				OrderPicker.getProfileIcon().click();
				Thread.sleep(2000);
				OrderPicker.getLogoutBtn().click();
				Thread.sleep(2000);
				OrderPicker.getOkBtn().click();
				Thread.sleep(2000);
				driver.quit();

...
@Listeners(genericUtility.ListnersImplementationClass.class)
	public class Negative_UserRegistration extends GoldBharat_BaseClass {
		...
		public void Registration () throws Exception
		{
			...
			RegistrationPage.clickOnRegisterBtn();
				...
				RegistrationPage.getPhoneNumber().sendKeys(PhoneNumber, Keys.TAB, "08/28/2024");
				Thread.sleep(3000);
				...
				js.executeScript("window.scrollBy(0, 200)");
				Thread.sleep(5000);
				RegistrationPage.getbusinessAddress().sendKeys(Keys.TAB,Keys.ENTER);
				wUtility.takeScreenShot(driver, "New User Registration") ;
				Thread.sleep(3000);
				RegistrationPage.clickOnPhoneNumber ();

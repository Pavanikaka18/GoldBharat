...
import objectRepository.GoldBharat_UserOrderPick;
	...
	public class User_OrderPick extends User_LoginPage {
		...
		public void login() throws Exception {
			...
			//Thread.sleep(2000);
			OrderPick.getOrderPick().click();
				Thread.sleep(1000);
				OrderPick.getOrderPick().sendKeys(Keys.ARROW_DOWN, Keys.ENTER);	
				OrderPick.getName().sendKeys("Pavani");
				OrderPick.getNumber().sendKeys("6309631698");
				OrderPick.getID().sendKeys("12345677888888");
				wUtility.scrolldown(driver);
				String projectPath= System.getProperty("user.dir");
				OrderPick.getUploadID().sendKeys(projectPath+"\\Images\\AadhaarCard.jpg");
				System.out.println(projectPath+"\\Images\\AadhaarCard.jpg");
				Thread.sleep(3000);
				OrderPick.getSubmit().click();
				//OrderPick.clickOnCloseBtn();
				//wUtility.scrolldown(driver);
				Thread.sleep(2000);
				OrderPick.getProfileIcon().click();

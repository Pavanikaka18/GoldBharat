...
import objectRepository.GoldBharat_UserOrderDelivered;
public class User_OrderDelivered extends User_LoginPage {
	...
	public void login() throws Exception {
		...
		GoldBharat_UserOrderDelivered OrderDelivered= new GoldBharat_UserOrderDelivered(driver);
		Thread.sleep(2000);
		...
		Thread.sleep(5000);
		OrderDelivered.getProfileIcon().click();
		Thread.sleep(2000);
		OrderDelivered.getOrders().click();
		Thread.sleep(5000);
		OrderDelivered.getProfileIcon().click();
		Thread.sleep(2000);
		OrderDelivered.getLogoutBtn().click();
		Thread.sleep(2000);
		OrderDelivered.getOkBtn().click();
		driver.quit();
